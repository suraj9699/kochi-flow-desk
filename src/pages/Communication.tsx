          ...
          <Card className="metro-card">
            ...
            <CardContent>
              ...
              <div className="space-y-3 mb-6 p-4 bg-surface-grey rounded-lg">
                <Textarea
                  placeholder="Post a new announcement (English/മലയാളം)..."
                ...
                {announcements.map((announcement) => (
                  <div
                    ...
                    className={`p-4 border rounded-lg transition-smooth ${
                      announcement.pinned ? 'border-primary-blue bg-metro-light' : 'border-border hover:bg-surface-grey'
                    }`}
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          {announcement.pinned && (
                            <Pin className="w-4 h-4 text-primary-blue" />
                          )}
                    ...
                    <div className="p-4 bg-surface-grey">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            setExpandedThread(
                              expandedThread === discussion.id ? null : discussion.id
                            )
                          }
                        >
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            {discussion.acknowledged.map((dept, index) => (
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            {discussion.pendingAck.map((dept, index) => (
                      ...
                      <div className="p-4 space-y-4">
                        ...
                        <div className="mt-4 pt-4 border-t border-border">
                          <div className="space-y-3">
                            <Textarea
                              placeholder="Add your comment (English/മലയാളം)..."
                              value={newComment}
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center space-x-2">
                                <Button
                                  variant="outline"
                                  size="sm"
                                  onClick={() => handleEscalate(discussion.id, discussion.documentTitle)}
                                >
