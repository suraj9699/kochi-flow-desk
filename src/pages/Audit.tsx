...
const Audit = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <Card className="metro-card border-warning-orange/20">
        <CardHeader>
        ...
        <CardContent>
          {anomalies.length > 0 ? (
                ...
                <div key={anomaly.id} className="p-4 border border-border rounded-lg">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-text-muted mb-2">{anomaly.description}</p>
                      <div className="flex items-center space-x-4 text-xs text-text-muted">
                        <span>{anomaly.time}</span>
                        <span>•</span>
                        <span>Detected by: {anomaly.user}</span>
                      </div>
                    </div>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-text-muted">No anomalies detected in the last 24 hours</p>
            </div>
          )}
        </CardContent>
      </Card>
      ...
      <Card className="metro-card border-primary-blue/20">
        <CardHeader>
          <CardTitle className="flex items-center space-x-2 text-primary-blue">
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-surface-grey rounded-lg">
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-success-green rounded-full"></div>
                <span className="font-mono text-sm">Block #2847</span>
                <span className="text-sm text-text-muted">Latest transactions secured</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              <div className="p-3 bg-surface-grey rounded-lg">
                <div className="text-2xl font-bold text-text-dark">2,847</div>
                <div className="text-sm text-text-muted">Total Transactions</div>
              </div>
              <div className="p-3 bg-surface-grey rounded-lg">
                <div className="text-2xl font-bold text-success-green">100%</div>
                <div className="text-sm text-text-muted">Integrity Verified</div>
              </div>
              <div className="p-3 bg-surface-grey rounded-lg">
                <div className="text-2xl font-bold text-primary-blue">0</div>
                <div className="text-sm text-text-muted">Tampering Attempts</div>
              </div>
            </div>
          </div>
        </CardContent>
